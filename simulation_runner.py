...
def run_simulation(
...
) -> List[tuple[PersonalState, FinancialState, YearlyDecisionsPlan]]:
    """
    ...
    for i in range(years):
        ...
        # 1. Simulate the year
        year_end_financial, decisions = simulate_financial_year(
        ...
        history.append((year_end_personal, year_end_financial, decisions))

        # Move to start of next year
        year_start_financial = replace(
            year_end_financial, year=year_end_financial.year + 1
        )
